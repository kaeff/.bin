...
class TestConvertDateFormat:
    def test_convert_date_format_1(self):
        ...
        assert convert_date_format(filename, old_format, new_format) == expected_filename
    ...
    def test_convert_date_format_with_space(self):
        ...
        assert convert_date_format(filename1, old_format1, new_format1) == expected_filename1
